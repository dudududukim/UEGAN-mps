...
def get_config():
    ...
    parser.add_argument('--seed', type=int, default=2025, help='Seed for random number generator')
    ...
    parser.add_argument('--lambda_adv', type=float, default=0.20, help='weight for adversarial loss')           # duhyoenkim : d2f에서는 empirically search 되어야 함
    ...
    # Directories.
    parser.add_argument('--train_img_dir', type=str, default='./data/d2f/train')
    parser.add_argument('--val_img_dir', type=str, default='./data/d2f/val')
    parser.add_argument('--test_img_dir', type=str, default='./data/d2f/test')
    parser.add_argument('--save_root_dir', type=str, default='./results')
    parser.add_argument('--val_label_dir', type=str, default='./data/d2f/val/label/')                         # 뭐하는 역할임? -> validation 만큼은 paired라는 가정으로 하는건데, 나는 지금 아애 unpaired임
    parser.add_argument('--test_label_dir', type=str, default='./data/d2f/test/label/')
    ...
    parser.add_argument('--is_test_psnr_ssim', type=str2bool, default=False)                                    # totally unpaired data = False (default)
